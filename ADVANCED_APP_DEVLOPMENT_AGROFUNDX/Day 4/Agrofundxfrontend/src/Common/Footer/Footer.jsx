    ...
    <>
      <footer className="  bg-[#18332f] h-full max-w-[100%]  bottom-0  text-white ">
        <button className="flex items-center gap-3">
          ...
          <span className="font-bold text-lg px-20  pt-20 text-[#8ba172] font-ambitextrabold">
            AgroFundX AS
          </span>
        </button>
        ...
        <section className="flex mt-10 items-center   border-bordergray divide-x-10 px-24 justify-between ">
          <div className="">
