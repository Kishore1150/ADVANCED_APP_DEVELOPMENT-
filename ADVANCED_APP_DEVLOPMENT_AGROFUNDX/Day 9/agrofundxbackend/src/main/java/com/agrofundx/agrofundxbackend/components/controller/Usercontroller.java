...
public class Usercontroller {
  ...
  public ResponseEntity<?> updateLoanDetails(@RequestBody LoanDetails loandetails,
    ...
    if (result) {
      return new ResponseEntity<>("User Loan details updated successfully", HttpStatus.OK);
    } else {

      return new ResponseEntity<>("Unable to update userloandetails", HttpStatus.BAD_REQUEST);
    }
